class WidgetInstance {
  ...
  openLogin(){
    ...
    this.loginOverlay.style.cssText = 'position: fixed; top: 0; bottom: 0; left: 0; right: 0;margin: auto;height:550px;background-color: #e2e2e2;width: 670px;z-index:100; display: flex;justify-content: center; align-items: center;border-radius: 7px';
